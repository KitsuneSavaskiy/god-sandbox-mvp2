# garan extended sprite sheet prompt (Sheet 2)
...
- Use the same visual style as Sheet 1 for garan for consistency.
...
- Adopted output: `public/art/characters/defaults/garan/sprites/resident-sprite-sheet-extended.png`
