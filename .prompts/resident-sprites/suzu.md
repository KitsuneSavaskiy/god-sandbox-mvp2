...
- Follow the visual correctness rules from `docs/operations/suzu-sprite-visual-correctness-task.md`.
...
- Adopted output after visual audit and human approval: `public/art/characters/defaults/suzu/sprites/resident-sprite-sheet.png`
...
- For this sprint, generate only Suzu. Do not expand to Eve, Garan, or Ryo.
