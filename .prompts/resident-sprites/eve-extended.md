# eve extended sprite sheet prompt (Sheet 2)
...
- Use the same visual style as Sheet 1 for eve for consistency.
...
- Adopted output: `public/art/characters/defaults/eve/sprites/resident-sprite-sheet-extended.png`
