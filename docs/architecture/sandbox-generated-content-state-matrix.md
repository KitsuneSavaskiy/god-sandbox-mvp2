...
- narrative状態: narrative pack または将来の narrative job review layer の `missing | pending | needs-review | rejected | ready`
...
- `pending`、`needs-review` などのjob review layer内部状態名
