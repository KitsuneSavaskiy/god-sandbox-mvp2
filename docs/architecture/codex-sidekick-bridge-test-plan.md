...
```bash
codex "Read docs/architecture/codex-sidekick-bridge-test-plan.md, implement the Codex Sidekick bridge or runner only after the Phase 1 gate docs are merged, and test until the safe fallback or preferred outcome is complete."
```
